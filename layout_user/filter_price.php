                    ...
                    <div class="col-md-10 product-box">
                        ...
                        <ul class='pagination home-product__pagination'>
                            <li class='pagination-item '>
                                <a href='../layout_user/filter_price.php?price=<?php echo $price?>&page=<?php echo $pageURLPrev; ?>' id="prevPage" class='pagination-item__link'>
                            ...
                            <li class='pagination-item'>
                                <a href='../layout_user/filter_price.php?price=<?php echo $price?>&page=<?php echo $pageURLNext; ?>' id="nextPage" class='pagination-item__link'>
